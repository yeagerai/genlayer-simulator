...
export type GetBlockReturnType<TChain extends Chain | undefined = undefined, TIncludeTransactions extends boolean = false, TBlockTag extends BlockTag = 'latest'> = Prettify<FormattedBlock<TChain, TIncludeTransactions, TBlockTag>>;
