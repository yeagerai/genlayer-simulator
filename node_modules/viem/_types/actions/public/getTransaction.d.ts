...
export type GetTransactionReturnType<TChain extends Chain | undefined = undefined, TBlockTag extends BlockTag = 'latest'> = Prettify<FormattedTransaction<TChain, TBlockTag>>;
