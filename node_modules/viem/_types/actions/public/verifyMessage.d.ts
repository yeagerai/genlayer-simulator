 ...
 */
export declare function verifyMessage<TChain extends Chain | undefined>(client: Client<Transport, TChain>, { address, message, factory, factoryData, signature, ...callRequest }: VerifyMessageParameters): Promise<VerifyMessageReturnType>;
