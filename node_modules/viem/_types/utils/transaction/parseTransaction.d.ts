...
export type ParseTransactionReturnType<TSerialized extends TransactionSerializedGeneric = TransactionSerialized, TType extends TransactionType = GetSerializedTransactionType<TSerialized>> = IsNarrowable<TSerialized, Hex> extends true ? (TType extends 'eip1559' ? TransactionSerializableEIP1559 : never) | (TType extends 'eip2930' ? TransactionSerializableEIP2930 : never) | (TType extends 'eip4844' ? TransactionSerializableEIP4844 : never) | (TType extends 'legacy' ? TransactionSerializableLegacy : never) : TransactionSerializable;
...
export declare function parseTransaction<const TSerialized extends TransactionSerializedGeneric>(serializedTransaction: TSerialized): ParseTransactionReturnType<TSerialized>;
