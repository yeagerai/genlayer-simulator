...
export type Block<quantity = bigint, TIncludeTransactions extends boolean = boolean, TBlockTag extends BlockTag = BlockTag, TTransaction = Transaction<bigint, number, TBlockTag extends 'pending' ? true : false>> = {
    /** Base fee per gas */
...
export type Uncle<quantity = bigint, TIncludeTransactions extends boolean = boolean, TBlockTag extends BlockTag = BlockTag, TTransaction = Transaction<bigint, number, TBlockTag extends 'pending' ? true : false>> = Block<quantity, TIncludeTransactions, TBlockTag, TTransaction>;
