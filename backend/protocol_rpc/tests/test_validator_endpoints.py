# from backend.tests.base import payload, post_request
...
#         payload("delete_validator", new_validator["result"]["data"]["address"])
#     ).json()
#     assert response["result"]["status"] == "success"
#     assert (
#         response["result"]["data"]["address"]
#         == new_validator["result"]["data"]["address"]
#     )
...
#     new_validator = post_request(payload("create_random_validator", 10)).json()
#     response = post_request(
#         payload("get_validator", new_validator["result"]["data"]["address"])
#     ).json()
#     assert response["result"]["status"] == "success"
