...
import { DocumentIcon, AdjustmentsHorizontalIcon, UserCircleIcon, CommandLineIcon, HandThumbUpIcon, DocumentTextIcon } from '@heroicons/vue/24/solid'
...
<template>
    <nav
        ...
        <div class="flex flex-col items-center">
            <RouterLink :to="{ name: 'simulator.contracts' }" id="tutorial-how-to-change-example"
            ...
            <RouterLink :to="{ name: 'simulator.run-debug' }" id="tutorial-how-to-deploy"
        ...
        <div class="flex flex-col items-center">
            <a href="https://genlayer-docs.netlify.app/" target="_blank"
            ...
            <a href="https://discord.gg/wNSBXcYmJP" target="_blank"
                class="p-3 border-r-4 border-transparent hover:border-r-primary hover:opacity-100">
            ...
            <a href="https://docs.google.com/forms/d/1IVNsZwm936kSNCiXmlAP8bgJnbik7Bqaoc3I6UYhr-o/viewform?edit_requested=true"
                target="_blank" class="p-3 border-r-4 border-transparent hover:border-r-primary hover:opacity-100">
