...
<template>
  <div class="flex overflow-y-auto px-6 py-2">
    <div class="flex">
            ...
            <ul>
              <li>
                ...
                <a
                  ...
                  target="_blank"
                  class="font-semibold text-primary underline dark:text-white"
                >
                  GPT-4
                </a>
                or
              ...
              <li>
                <b>Internet Access:</b> Genlayer is the first platform where
      ...
      <div class="flex h-full w-full flex-col md:ml-6 md:w-2/5">
        ...
        >
          ...
          >
            ...
            <div class="mt-1 text-justify text-sm">
              Dive into the <b>"Wizard of Coin"</b> template that allows you to
              interact with a magical world. In this scenario, you meet a wizard
              who guards a highly sought-after coin. Test your skills and
              strategy to see if you can convince the wizard to hand over the
              coin. This template is perfect for learning how Intelligent
              Contracts can manage interactions and asset control in a fun and
              engaging way.
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="mt-1 text-justify text-sm">
              Explore the <b>"Simple Storage"</b> template to understand the
              basics of Intelligent Contracts. This template offers a
              straightforward platform where you can store, retrieve, and update
              data. It's an excellent starting point for anyone new to
              blockchain technology, demonstrating how simple it is to interact
              with a decentralized database using Intelligent Contracts.
            </div>
          </div>
        </div>
      </div>
