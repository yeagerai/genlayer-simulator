...
const contractFunctionLogs = [
  ...
  "Leader {'id': 2, 'address': '0xBfE0B24B9C86D54384BAdC0426C7A7BDe7f71DFA', 'stake': 1.6300447758707397, 'provider': 'openai', 'model': 'gpt-3.5-turbo', 'config': {}, 'updated_at': '06/17/2024, 21:47:04'} starts contract execution...",
  "Leader {'id': 2, 'address': '0xBfE0B24B9C86D54384BAdC0426C7A7BDe7f71DFA', 'stake': 1.6300447758707397, 'provider': 'openai', 'model': 'gpt-3.5-turbo', 'config': {}, 'updated_at': '06/17/2024, 21:47:04'} has finished contract execution...",
  'Transaction has been fully executed...',
  "This is the data produced by the leader:\n\n {'vote': 'agree', 'result': {'args': ['test'], 'class': 'Storage', 'contract_state': 'gASVMAAAAAAAAACMCF9fbWFpbl9flIwHU3RvcmFnZZSTlCmBlH2UjAdzdG9yYWdllIwEdGVzdJRzYi4=', 'eq_outputs': {'leader': {}}, 'gas_used': 0, 'method': 'update_storage', 'mode': 'leader', 'node_config': {'address': '0xBfE0B24B9C86D54384BAdC0426C7A7BDe7f71DFA', 'config': {}, 'id': 2, 'model': 'gpt-3.5-turbo', 'provider': 'openai', 'stake': 1.6300447758707397, 'type': 'leader', 'updated_at': '06/17/2024, 21:47:04'}}}",
  'Transaction ID:\n\n None',
  {
    function: 'call_contract_function',
    trace_id: 'ljpjjd852',
