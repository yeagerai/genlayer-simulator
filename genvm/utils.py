...
def save_files(icontract:str, node_config:str, node_type:str, leader_recipt:str = None):
...
def webrequest_url():
    return os.environ['WEBREQUESTPROTOCOL']+'://'+os.environ['WEBREQUESTHOST']+':'+os.environ['WEBREQUESTPORT']